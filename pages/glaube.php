<div id='goetter'>
    <br><br>
    <h1 class='font-bold text-lg text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-5 mb-5 p-2'>Unsere Götter</h1>
    <img src='img/glaube/natur3.jpg' class='md:float-left m-5 w-60'>
    ...
    <div class='flex flex-wrap justify-center'>
        <div class='text-white m-2 pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=glaube#gott1'>Odin/Wotan/Wuodan</a></div>
        <div class='text-white m-2 pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=glaube#gott2'>Frigga/Frigg</a></div>
        <div class='text-white m-2 pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=glaube#gott3'>Thor/Donar</a></div>
        <div class='text-white m-2 pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=glaube#gott4'>Tyr/Ziu</a></div>
        <div class='text-white m-2 pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=glaube#gott5'>Balder/Baldur/Phol</a></div>
        <div class='text-white m-2 pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=glaube#gott6'>Freya</a></div>
    </div>
...
<div id='gott1'>
    <br><br>
    <h1 class='font-bold text-base text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-3 mb-3 p-2'>Odin/Wotan/Wuodan</h1>   
    Nicht nur die Edda erzählt uns von Ihm, sondern auch in alt her überlieferten Sagen und Geschichten. Odin ist eine vielschichtige Gottheit mit vielen Facetten und Gesichtern. "Wodan id est furor " so berichtete einst der Missionar Adam von Bremen. Übersetzt wird das oft als "Odin ist Wut". Einen ähnlichen Begriff "furore machen" gibt es noch im heutigen Gebrauch. Wikipedia meint dazu :"Die Ableitung des italienischen  Ausdrucks Furore für rasenden Beifall sowie Leidenschaftlichkeit wird im Zusammenhang mit Furore machen als großes Aufsehen erregen und Beifall erringen definiert." Wir würden es dann (unwissenschaftlich) auch so übersetzen "Odin ist Extase".<br>
    Er verfolgt kompromisslos sein Ziel, und fordert viel von denen die Ihm folgen. Auf der Suche nach Erkenntnis opfert er sein Auge für einen Schluck aus Mirmirs Brunnen der Weisheit. Mehr noch - er hängt sich 9 Tage und Nächte an den Weltenbaum, opfert sich letztlich mit dem Speer selbst, und findet so die Runen.<br>
    Er ist als einziger männlicher Gott als zauberkundig bekannt . Von Freya laesst er sich die Seidh - Kunst lehren.<br>
    Er ist der Gott, der vor der Schlacht um den Sieg angerufen wurde.<br>
    Aber ebenso ist er der Gott der Poesie. Er entfuehrt den Odroerir, den Dichtermet. Der Legende nach wurde derjenige der davon trank zum Dichter.<br>
    Als  Sturmgott wird über Ihn auch aus der Schweiz als Anführer des Wuotisheers (der wilden Jagd) berichtet.<br>
    Als einsamer Wanderer zieht er durch Mittgard, die Welt der Menschen.<br>
...
<div id='gott2'>
    <br><br>
    <h1 class='font-bold text-base text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-3 mb-3 p-2'>Frigga/Frigg</h1>   
...
<div id='gott3'>
    <br><br>
    <h1 class='font-bold text-base text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-3 mb-3 p-2'>Thor/Donar</h1>   
...
<div id='gott4'>
    <br><br>
    <h1 class='font-bold text-base text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-3 mb-3 p-2'>Tyr/Ziu</h1>   
    Bei Mittel und Südgermanen heisst er Ziu, Tsiu althochdeutsch Teiwaz oder Tiwaz.<br>
...
<div id='gott5'>
    <br><br>
    <h1 class='font-bold text-base text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-3 mb-3 p-2'>Balder/Baldur/Phol</h1>   
...
<div id='gott6'>
    <br><br>
    <h1 class='font-bold text-base text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-3 mb-3 p-2'>Freya</h1>   
...
<div id='naturreligion' class='mt-32'>
    <br><br>
    <h1 class='font-bold text-lg text-white bg-gradient-to-r from-lime-600 to-lime-800 text-center border-2 border-solid border-white mt-5 mb-5 p-2'>Naturreligion</h1>
    <img src='img/glaube/trommelrunen.jpg' class='md:float-left mr-5 mb-5 w-96'>
    ...
    So konnten Frigga und Odin, obwohl sie es vorher sehen konnten, nicht verhindern das Ihr Sohn Balder letztlich durch Loki den Tod erleidete und ins Totenreich zu Hel ging. Dies ist ein prägnanter Unterschied zu monotheistischen Religionen, in denen der einzige Gott allmächtig ist und nicht ein Schicksal erleidet sondern dieses selbst für alles Lebendige bestimmt.<br>
    Die sogenannte "sekundäre Mythologie" nennt uns die Geister der Natur beim Namen. Elfen, Zwerge und Riesen sind für uns nicht nur Sinnbilder der Naturkräfte.<br>
    Auch unsere Ahnen sind in diesem Zusammenhang gegenwärtig und Ihre Verehrung macht uns unsere Wurzeln und Herkunft bewusst und geben uns Halt im Alltag.<br>
