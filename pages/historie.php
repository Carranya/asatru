<div id='alemannen'>
    ...
    <br>
    <span class='text-green-600'>Grüne Markierungen: Alemannische Siedlungsgründungen</span><br><br>
    <span class='text-xs'>
    Quellen:<br>
    Karte: „Die Schweiz vom Paläolithikum bis zum frühen Mittelalter“ SPM Band VI. Verlag Schweizerische Gesellschaft für Ur- und Frühgeschichte, Basel (Seite 57).<br>
    Die Schweiz zwischen Antike und Mittelalter, Andres Furger, Verlag NZZ<br>
    Die Alamannen, Archaeologisches Landesmuseeum Baden Wuerttemberg, Theiss Verlag<br>
    Die Alamanen, Karin Krupp, Theiss Verlag<br>
...
<div id='gallus'>
    ...
    Deren Sichtweise und Handlungen waren zwar alles andere als wohlmeinend - doch können wir einiges entnehmen.<br>
    Zunächst reisten die beiden Missionare 610 n.d.Z. nach Tuggen am Zürichsee, wo sie einen oder mehrere Tempel der Alemannen vorfanden ! Es wird davon ausgegangen, dass diese Holzbauten waren, und so steckten sie einen in Brand, um die Überlegenheit ihres Gottes zu beweisen. Die Opfergaben warfen sie in den See. Daher müssten sie aus Metall gewesen sein. Die Tuggener allerdings liessen sich nicht auf diese unfreundliche Art bekehren, sondern beschlossen auf einem Thing Gallus nach dem Leben zu trachten und Columban zu vertreiben.Auf der Flucht verfluchten sie die Tuggener Bevölkerung.<br>
    Nach einem Zwischenstopp in Arbon, reisten sie weiter nach Bregenz wo sie in einer ehemaligen Kirche 3 vergoldete, eherne heidnische Götterbilder vorfanden, die von der einheimischen Bevölkerung dort als "Hauptgötter" verehrt wurden. Leider ist hier nicht überliefert, um welche Götter es sich gehandelt hat. Es gibt lediglich Vermutungen, dass es sich um Wodan, Donar und Ziu gehandelt haben könnte.<br>
    Auch hier zerschmettern die Missionare die Götterbildnisse, und werfen die Stücke in den Bodensee.<br>
    Columban trifft später dann Heiden an, die ein Bieropfer für Wodan in einem Kessel vorbereiten. Glücklicherweise wird der Name des Gottes genannt, und so können wir belegen, dass Wodan von den Alemannen verehrt wurde.<br>
    Auch hier zerstört Columban den Opferkessel.<br>
    In der Vita  nach Wetti begegnen die Missionare während ihrer Reise auch Wesen aus der heidnischen "sekundären Mythologie" - Naturgeistern, wie Wassergeistern, Nixen und Berggeistern, aber auch Alb, Schrat oder Nachtmahr.<br>
    Die Nixen werden als Schutzgeister der Fische dargestellt.<br>
    Aus dem Lebensbericht der Missionare kann man ersehen, dass sie zwar rücksichtslos gegen den heidnischen Glauben vorgingen, aber die Existenz der germanischen Götter und Geister nicht leugneten.<br>
    Ferner berichtet etwa zur Mitte des 6. Jahrhunderts der byzantinische Geschichtsschreiber Agathias aus Myrina in seinem Bericht über den Krieg der Franken und Goten gegen die Byzantiner, daß sich die im Heer des Frankenkönigs Theudebald mitkämpfenden Alamannen lediglich in Bezug auf ihre Religion von den Franken unterscheiden, da sie "irgendwelche Bäume und Flüsse, Hügel und Schluchten wie Götter verehren."<br><br>
    <span class='text-xs'>
    Quellen:<br>
    Columban und Gallus - Urgeschichte des schweizerischen Christentums, Fritz Blanke, Fretz und Wasmuth Verlag Zürich<br>
    Römer -Heilige-Alemannen im Zürichbiet, v. A.Tanner<br>
...
<div id='arch'>
    ...
    <div class='flex flex-wrap justify-center'>
        ...
        <div class='text-white pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=historie#arch2'>Grab in Kaiseraugst mit 2 Grabsteinen</a></div>
        <div class='text-white pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=historie#arch3'>Bügelfibel aus Hüfingen</a></div>
        <div class='text-white pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=historie#arch4'>Scheibenfibel von Bülach</a></div>
        <div class='text-white pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=historie#arch5'>Runenspange von Nordendorf</a></div>
        <div class='text-white pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=historie#arch6'>Scheidenmundblech eines Spatha</a></div>
        <div class='text-white pt-3 pb-3 pl-5 pr-5 bg-lime-600 hover:bg-lime-500 border-white border-solid border-2'><a href='index.php?page=historie#arch7'>Columban und die Götterbildnisse</a></div>
